...
"@
        ...
        'E-ALLANDFAKE' {
            ...
            $sql = @"
            SELECT U.MigUnitId AS MigUnitId, EnvironmentName, CompleteSourceUrl,SitePermissionsSource, SourceUrl, DestinationUrl, DuplicateTargetLibPrefix, TargetLibPrefixGiven, ListUrl, ListTitleWithPrefix, ListTitle, ListId,  InheritFromSource, UniquePermissions, MergeMUS,  ShareGateCopySettings, Scope, MUStatus, NodeId, NextAction, MAX(StartTime) AS LastStartTime
            FROM MIgrationUnits AS U
            LEFT OUTER JOIN
            MigrationRuns AS R
            ON U.MigUnitId = R.MigUnitId
            ...
            GROUP BY U.MigUnitId, EnvironmentName, CompleteSourceUrl, SitePermissionsSource,SourceUrl, DestinationUrl, DuplicateTargetLibPrefix, TargetLibPrefixGiven, ListUrl, ListTitleWithPrefix, ListTitle, ListId, InheritFromSource, UniquePermissions, MergeMUS,  ShareGateCopySettings, Scope, MUStatus, NodeId, NextAction
            ORDER BY SourceURL;
"@
        }
        'E-ALL' {
