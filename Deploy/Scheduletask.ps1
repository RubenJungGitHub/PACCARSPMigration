...
$scriptblock = {
    ...
    #Start-MtHLocalPowerShell -settingfile 'D:\Beheer\BuZaShareGate\settings.json'
    ...
    # USE SINGLE QUOTES
    $Action = New-ScheduledTaskAction -Execute 'powershell.exe' -Argument '-NoProfile -WindowStyle Hidden -File .\Deploy\RunTask.ps1' -WorkingDirectory 'D:\Beheer\BuzaShareGate' 
